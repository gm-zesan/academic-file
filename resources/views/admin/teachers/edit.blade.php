...
@section('content')
    <div class="container-fluid my-3">
        <form action="{{ route('admin.teachers.update', $user) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-8 col-12">
                    <div class="card table-card">
                        <div class="card-header table-header">
                            ...
                            <a href="{{route('admin.teachers.index')}}" class="add-new">Teacher List<i class="ms-1 ri-list-ordered-2"></i></a>
                        </div>
                        <div class="card-body custom-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control custom-input" name="phone" value="{{$user->phone}}">
                                    @if($errors->has('phone'))
                                        <div class="error_msg">
                                            {{ $errors->first('phone') }}
                                        </div>
                            ...
                            <div class="card table-card">
                                ...
                                <div class="custom-form card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <a href="{{route('admin.teachers.index')}}" class="btn leave-button">Leave</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
