...
@section('content')
    ...
    <div class="container-fluid my-3">
        <form action="{{ route('admin.teachers.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf
            <div class="row">
                        ...
                        <div class="card-body custom-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control custom-input" name="phone" placeholder="Phone No">
                                    @if($errors->has('phone'))
                                        <div class="error_msg">
                                            {{ $errors->first('phone') }}
                                        </div>
