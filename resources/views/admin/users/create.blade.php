                ...
                <div class="col-md-8 col-12">
                    <div class="card table-card">
                        <div class="card-header table-header">
                            ...
                            <a href="{{route('admin.users.index')}}" class="add-new">User List<i class="ms-1 ri-list-ordered-2"></i></a>
                        </div>
                            ...
                            <div class="card table-card">
                                ...
                                <div class="custom-form card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <a href="{{route('admin.users.index')}}" class="btn leave-button">Leave</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
